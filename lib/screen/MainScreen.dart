...
import 'package:practice_flutter_app/screen/PostsScreen.dart';
import 'package:practice_flutter_app/screen/CommentsScreen.dart';
...
class _MainScreenState extends State<MainScreen>
    with SingleTickerProviderStateMixin,AutomaticKeepAliveClientMixin<MainScreen> {
   int _myHandler=0;
  //list of pages needed
  final pageTitle = ["Posts", "Comments"];
  ...
  void _handleSelected() {
    setState(() {
      _myHandler= tabController.index;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title:  new Text(pageTitle[_myHandler]
          , //as we made a list called pageTitle, we can now get the title of the tabs by accessing index
      ...
      body: TabBarView(
          ...
          children: [PostsScreen(),CommentsScreen()]), //passing all the screen classes as children of TabBarView so that it displays our screens on each swipe
